...
class FeekForm(forms.ModelForm):
    body = forms.CharField(
        required=True,
        widget=forms.widgets.Textarea(
            attrs={"placeholder": "Make a feek!", "class": "form-control"}
        ),
        label="",
    )
...
# -------------- Classes to update profile made for me -----------------------------------
...
class UserConfirmationForm(forms.ModelForm):
    ...
    password = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": "Confirm with password"}
        ),
    )
